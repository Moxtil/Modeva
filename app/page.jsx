  ...
  return (
    <main className="min-h-screen">
      <div className="py-10 min-h-screen flex flex-col justify-evenly gap-10 bg-cover bg-center bg-[url('./assets/Frame.png')] p-4">
        <section className="flex flex-col gap-5 items-center text-center justify-center h-1/2">
        ...
        <section className="flex flex-wrap justify-center items-center gap-4">
          <ShopCard img={img1} category={"Men's Clothing"} title={"50% Off"} />
          <ShopCard
            img={img4}
      ...
      <section className="my-14 p-3">
        ...
        <div className="flex justify-center items-center gap-4 p-2 flex-wrap">
          <ShopCardTwo img={womenImg1} rate={"4.2"} desc={"Timeless Beauty"} />
